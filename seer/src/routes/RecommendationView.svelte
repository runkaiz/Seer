...
{#if recommendation}
    <div class="max-w-3xl mx-auto">
        ...
        >
            ...
            <div class="flex flex-col gap-1 mb-5 text-sm">
                <span
            ...
            <div
                class="flex items-center gap-4 mb-4 text-sm text-slate-600 dark:text-slate-400"
            >
                ...
                {#if recommendation.studios.length > 0}
                    <span>{recommendation.studios.join(", ")}</span>
                {/if}
            </div>
